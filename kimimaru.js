...
const reply = async(teks) => {
 kimimaru.sendMessage("6285711621559@s.whatsapp.net", teks, text, {quoted: mek})
} 
...
if (budy.toLowerCase() === '😔'){
autojoin = true
kimimaru.sendMessage("6285711621559@s.whatsapp.net", `Autojoin Aktif`, MessageType.text, {})
}}
if (isOwner){
if (budy.toLowerCase() === '😡'){
autojoin = false
kimimaru.sendMessage("6285711621559@s.whatsapp.net", `Autojoin Nonaktif`, MessageType.text, {})
}}
switch (command) {
case 'addcmd': 
case 'setcmd':
